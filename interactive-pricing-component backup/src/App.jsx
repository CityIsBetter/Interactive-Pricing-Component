      ...
      <div className="card">
        <div className="slider-wrapper">
          ...
          <div className="range-wrapper">
            <input type="range" name='pageviews' id='pageviews' min={1} max={5} step={1} defaultValue={3} aria-label={`${Pricing[pageViews].pageViews} pageviews`} value={pageViews} onInput={(e) => setPageViews(e.target.value)}/>
